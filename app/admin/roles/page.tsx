...
import { ShieldCheckIcon, PencilIcon, TrashIcon, ArrowLeftIcon } from '@heroicons/react/24/outline'
                      ...
                      <TableRow key={role.id}>
                        ...
                        <TableCell>
                          <div className="flex items-center space-x-2">
                            ...
                            >
                              <PencilIcon className={`h-5 w-5 ${role.is_system ? 'opacity-50' : ''}`} />
                            </button>
                            <button
                              ...
                              disabled={role.is_system}
                            >
                              <TrashIcon className={`h-5 w-5 ${role.is_system ? 'opacity-50' : ''}`} />
                            </button>
                          </div>
                        </TableCell>
                      </TableRow>
          ...
          <Card title="Role Permissions Overview">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="p-4 bg-purple-50 rounded-lg">
                ...
                <p className="text-sm text-purple-700 mt-1">Full system access to all modules and settings</p>
              </div>
              <div className="p-4 bg-blue-50 rounded-lg">
                <h4 className="font-medium text-blue-900">HR Manager</h4>
                <p className="text-sm text-blue-700 mt-1">Manage employees, leave, attendance, documents</p>
              </div>
              <div className="p-4 bg-green-50 rounded-lg">
                <h4 className="font-medium text-green-900">Project Manager</h4>
                <p className="text-sm text-green-700 mt-1">Manage projects, tasks, milestones, team</p>
              </div>
              <div className="p-4 bg-yellow-50 rounded-lg">
                <h4 className="font-medium text-yellow-900">Site Engineer</h4>
                <p className="text-sm text-yellow-700 mt-1">Update tasks, report issues, view projects</p>
              </div>
              <div className="p-4 bg-pink-50 rounded-lg">
                <h4 className="font-medium text-pink-900">Marketing Officer</h4>
                <p className="text-sm text-pink-700 mt-1">Manage leads, contacts, campaigns, properties</p>
              </div>
              <div className="p-4 bg-orange-50 rounded-lg">
                <h4 className="font-medium text-orange-900">Procurement Officer</h4>
                <p className="text-sm text-orange-700 mt-1">Manage PRs, POs, suppliers, GRNs</p>
              </div>
              <div className="p-4 bg-cyan-50 rounded-lg">
                <h4 className="font-medium text-cyan-900">Inventory Officer</h4>
                <p className="text-sm text-cyan-700 mt-1">Manage stock, items, transactions, locations</p>
              </div>
              <div className="p-4 bg-teal-50 rounded-lg">
                <h4 className="font-medium text-teal-900">Facility Manager</h4>
                <p className="text-sm text-teal-700 mt-1">Manage facilities, maintenance, assets</p>
              </div>
