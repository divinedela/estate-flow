  ...
  useEffect(() => {
    async function fetchData() {
      ...
      setFormData({
        ...
        actual_start_date: project.actual_start_date ? new Date(project.actual_start_date).toISOString().split('T')[0] : '',
        actual_end_date: project.actual_end_date ? new Date(project.actual_end_date).toISOString().split('T')[0] : '',
        budget: project.budget ? project.budget.toString() : '',
        actual_cost: project.actual_cost ? project.actual_cost.toString() : '',
        location: project.location || '',
        address: project.address || '',
        latitude: project.latitude ? project.latitude.toString() : '',
        longitude: project.longitude ? project.longitude.toString() : '',
        project_manager_id: project.project_manager_id || '',
        progress_percentage: project.progress_percentage ? project.progress_percentage.toString() : '',
      })
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const updateData: any = {
        ...
        progress_percentage: formData.progress_percentage ? parseFloat(formData.progress_percentage) : null,
      }
