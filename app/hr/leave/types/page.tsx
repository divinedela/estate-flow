                    ...
                    <TableRow key={type.id}>
                      <TableCell>
                        <div>
                          ...
                          {type.description && (
                            <p className="text-sm text-gray-500 truncate max-w-xs">{type.description}</p>
                          )}
                        </div>
                      </TableCell>
                      <TableCell>
                      ...
                      <TableCell>
                        <span className={`px-2 py-1 text-xs font-medium rounded-full ${
                          type.requires_approval ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800'
                        }`}>
                      ...
                      <TableCell>
                        <div className="flex items-center space-x-2">
                          ...
                          <button
                            ...
                            className={type.is_active ? 'text-yellow-600 hover:text-yellow-900' : 'text-green-600 hover:text-green-900'}
                          >
          ...
          <Card title="Common Leave Types">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
              <div className="p-4 bg-blue-50 rounded-lg">
                ...
                <p className="text-blue-700 mt-1">Paid time off for vacation and personal time</p>
              </div>
              <div className="p-4 bg-green-50 rounded-lg">
                <p className="font-medium text-green-900">Sick Leave</p>
                <p className="text-green-700 mt-1">Time off for illness or medical appointments</p>
              </div>
              <div className="p-4 bg-purple-50 rounded-lg">
                <p className="font-medium text-purple-900">Maternity/Paternity Leave</p>
              ...
              <div className="p-4 bg-yellow-50 rounded-lg">
                ...
                <p className="text-yellow-700 mt-1">Leave for family emergencies or bereavement</p>
              </div>
              ...
              <div className="p-4 bg-pink-50 rounded-lg">
                ...
                <p className="text-pink-700 mt-1">Time off for education and training</p>
              </div>
            </div>
          </Card>
        </div>
