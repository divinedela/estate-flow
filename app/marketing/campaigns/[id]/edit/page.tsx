...
export default function EditCampaignPage() {
  ...
  async function fetchCampaign() {
    ...
    setFormData({
      ...
      actual_spend: data.actual_spend?.toString() || '',
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const { error } = await supabase
      ...
      .update({
        ...
        actual_spend: formData.actual_spend ? parseFloat(formData.actual_spend) : null,
  ...
  const campaignTypes = ['digital', 'print', 'email', 'social_media', 'event', 'referral', 'other']
  const channelOptions = ['Facebook', 'Instagram', 'Twitter', 'LinkedIn', 'Google Ads', 'Email', 'Print', 'TV', 'Radio', 'Billboard', 'Event', 'Referral']
    ...
    <RoleGuard allowedRoles={['super_admin', 'marketing_officer']}>
        <div className="space-y-6">
          ...
          <div className="flex items-center space-x-4">
            <Link href={`/marketing/campaigns/${params.id}`} className="text-gray-500 hover:text-gray-700">
