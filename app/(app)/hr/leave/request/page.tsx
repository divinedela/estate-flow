...
import { ArrowLeftIcon, CalendarIcon, ClockIcon, ExclamationTriangleIcon, PlusIcon } from '@heroicons/react/24/outline'
...
export default function RequestLeavePage() {
  ...
  async function fetchLeaveBalance(employeeId: string, leaveTypeId: string) {
    ...
    if (data) {
      const available = (data.allocated_days || 0) + (data.carried_forward_days || 0) - (data.used_days || 0) - (data.pending_days || 0)
      setSelectedBalance({
        ...
        <div className="space-y-6 max-w-3xl mx-auto">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="mt-1 text-sm text-yellow-700">
                    You need to set up leave types before you can submit leave requests.
                  </p>
          ...
          {employees.length === 0 && (
            <Card className="border-yellow-200 bg-yellow-50">
              <div className="flex items-start space-x-3">
                <ExclamationTriangleIcon className="h-6 w-6 text-yellow-600 flex-shrink-0" />
                <div className="flex-1">
                  <h3 className="text-sm font-medium text-yellow-800">No Active Employees</h3>
                  <p className="mt-1 text-sm text-yellow-700">
                    You need to add employees before you can submit leave requests.
                  </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <Link href="/hr/leave/types" className="text-xs text-indigo-600 hover:text-indigo-500">
                      Manage Leave Types
                    </Link>
                  </div>
                  <FormSelect
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    ...
                    {selectedBalance.pending_days > 0 && (
                      <p className="mt-2 text-xs text-blue-700">
                        Note: {selectedBalance.pending_days} day(s) pending approval
                      </p>
                    )}
                  </div>
                )}
              ...
              <Card title="Leave Type Information">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{selectedLeaveType.requires_approval ? 'Yes' : 'No'}</p>
                  </div>
                  <div>
            ...
            <div className="flex justify-end space-x-4">
              ...
              <Button 
                type="submit" 
                disabled={submitting || (selectedBalance !== null && daysRequested > selectedBalance.available)}
              >
