                    ...
                    employees.map((employee) => {
                      ...
                      return (
                        <TableRow key={employee.id} className="hover:bg-gray-50">
                          ...
                          <TableCell className="text-sm text-gray-900">{employee.department || 'N/A'}</TableCell>
                          <TableCell className="text-sm text-gray-900">{employee.position || 'N/A'}</TableCell>
                          <TableCell className="text-sm text-gray-500">{employee.email || 'N/A'}</TableCell>
                          <TableCell className="text-sm text-gray-500">{employee.phone || 'N/A'}</TableCell>
                          <TableCell>
                            <span className={`inline-flex rounded-full px-2 text-xs font-semibold leading-5 ${statusColors[employee.status || 'active'] || statusColors.active}`}>
                              {employee.status || 'active'}
                            </span>
                          </TableCell>
                          <TableCell className="text-sm font-medium">
                            <Link href={`/hr/employees/${employee.id}`} className="text-indigo-600 hover:text-indigo-900">
                              View Details
                            </Link>
                          </TableCell>
                        </TableRow>
