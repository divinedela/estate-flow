  ...
  useEffect(() => {
    async function fetchData() {
      ...
      setFormData({
        ...
        interest_type: leadData.interest_type || "buy",
        budget_min: leadData.budget_min ? leadData.budget_min.toString() : "",
        budget_max: leadData.budget_max ? leadData.budget_max.toString() : "",
        preferred_location: leadData.preferred_location || "",
        preferred_property_type:
          leadData.preferred_property_type || "apartment",
        expected_timeline: leadData.expected_timeline || "",
        notes: leadData.notes || "",
        next_follow_up_date: leadData.next_follow_up_date
          ? new Date(leadData.next_follow_up_date).toISOString().slice(0, 16)
          : "",
      });
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <FormSelect
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      preferred_property_type: e.target.value,
                    })
                  }
                  options={[
                ...
                <FormInput
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      expected_timeline: e.target.value,
                    })
                  }
