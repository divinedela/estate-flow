...
export default function NewLeadPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const orgId = (profile as any).organization_id;
      const appUserId = (profile as any).id;
      ...
      if (createNewContact && formData.first_name) {
        const { data: newContact, error: contactError } = await (
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <FormSelect
                  ...
                  options={[
                    ...
                    {
                      value: "contacted",
                      label: "📞 Contacted - Initial outreach done",
                    },
                    {
                      value: "qualified",
                      label: "✅ Qualified - Meets criteria",
                    },
                    {
                      value: "negotiating",
                      label: "🤝 Negotiating - In discussions",
                    },
                ...
                <div className="sm:col-span-2">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <button
                      type="button"
                      onClick={() =>
                        setFormData({ ...formData, temperature: "hot" })
                      }
                    ...
                    <button
                      type="button"
                      onClick={() =>
                        setFormData({ ...formData, temperature: "cold" })
                      }
                      className={`p-4 rounded-lg border-2 transition-all ${
