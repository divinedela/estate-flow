...
export default function CampaignDetailPage() {
  ...
  const [stats, setStats] = useState<CampaignStats>({ totalLeads: 0, convertedLeads: 0, conversionRate: 0 })
  ...
  if (!campaign) {
    return (
      <div className="text-center py-12">
          ...
          <Link href="/marketing/campaigns" className="text-indigo-600 hover:text-indigo-500 mt-2 inline-block">
            Back to Campaigns
          </Link>
        </div>
    )
  ...
  const budgetUsed = campaign.budget && campaign.actual_spend 
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              <span className={`px-3 py-1 text-sm font-medium rounded-full ${statusColors[campaign.status]}`}>
                {campaign.status}
              </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <Card>
              <div className="text-center">
                ...
                <p className="text-2xl font-bold text-gray-900 mt-2">{stats.convertedLeads}</p>
            ...
            <div className="lg:col-span-2 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium capitalize">{campaign.campaign_type || 'N/A'}</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{campaign.target_audience || 'N/A'}</p>
                  </div>
                  <div>
              ...
              {campaign.goals && (
                <Card title="Campaign Goals">
                  <p className="text-gray-700 whitespace-pre-wrap">{campaign.goals}</p>
                </Card>
              )}
            </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-green-600">
                      ${((campaign.budget || 0) - (campaign.actual_spend || 0)).toLocaleString()}
                    </span>
                  </div>
                  {campaign.budget && campaign.budget > 0 && (
                    <div>
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-2">
                        <div 
                          className={`h-2 rounded-full ${budgetUsed > 100 ? 'bg-red-600' : budgetUsed > 80 ? 'bg-yellow-500' : 'bg-green-500'}`}
                ...
                <div className="space-y-3">
                  <div className="flex items-center text-sm">
                    ...
                    <div>
                      ...
                      <p className="text-gray-500">{new Date(campaign.created_at).toLocaleDateString()}</p>
                    </div>
                  </div>
                  {campaign.start_date && (
                    <div className="flex items-center text-sm">
                      ...
                      <div>
                        ...
                        <p className="text-gray-500">{new Date(campaign.start_date).toLocaleDateString()}</p>
                      </div>
                    </div>
                  )}
                  {campaign.end_date && (
                    <div className="flex items-center text-sm">
                      ...
                      <div>
                        ...
                        <p className="text-gray-500">{new Date(campaign.end_date).toLocaleDateString()}</p>
                      </div>
                    </div>
                  )}
                </div>
