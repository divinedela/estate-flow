    ...
    async function fetchData() {
      ...
      setFormData({
        ...
        total_area: propertyData.total_area
          ? propertyData.total_area.toString()
          : "",
        built_up_area: propertyData.built_up_area
          ? propertyData.built_up_area.toString()
          : "",
        ...
        parking_spaces: propertyData.parking_spaces
          ? propertyData.parking_spaces.toString()
          : "",
        ...
        rent_price: propertyData.rent_price
          ? propertyData.rent_price.toString()
          : "",
    ...
    try {
      ...
      const updateData: any = {
        ...
        built_up_area: formData.built_up_area
          ? parseFloat(formData.built_up_area)
          : null,
        ...
        listing_price: formData.listing_price
          ? parseFloat(formData.listing_price)
          : null,
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              <FormInput
                ...
                onChange={(e) =>
                  setFormData({ ...formData, property_code: e.target.value })
                }
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <FormInput
                ...
                onChange={(e) =>
                  setFormData({ ...formData, built_up_area: e.target.value })
                }
                placeholder="0.00"
              />
              <FormInput
              ...
              <FormInput
                ...
                onChange={(e) =>
                  setFormData({ ...formData, parking_spaces: e.target.value })
                }
                placeholder="0"
              />
            </div>
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              <FormInput
                ...
                onChange={(e) =>
                  setFormData({ ...formData, listing_price: e.target.value })
                }
                placeholder="0.00"
              />
              <FormInput
