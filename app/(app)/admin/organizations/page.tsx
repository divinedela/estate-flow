...
import { BuildingLibraryIcon, PencilIcon, TrashIcon, ArrowLeftIcon } from '@heroicons/react/24/outline'
...
export default function OrganizationsPage() {
  ...
  async function handleDelete(org: Organization) {
    if (org.user_count && org.user_count > 0) {
      alert('Cannot delete organization with active users. Please reassign users first.')
      return
    }
            ...
            <Card>
              <div className="text-center">
                <p className="text-3xl font-bold text-blue-600">
                  {organizations.filter(org => org.user_count && org.user_count > 0).length}
                </p>
                      ...
                      <TableRow key={org.id}>
                        <TableCell>
                          <div>
                            ...
                            {org.address && (
                              <p className="text-sm text-gray-500 truncate max-w-xs">{org.address}</p>
                            )}
                          </div>
                        </TableCell>
                        <TableCell>
                        ...
                        <TableCell>
                          <div className="text-sm">
                            ...
                            {!org.email && !org.phone && <span className="text-gray-400">-</span>}
                          </div>
                        </TableCell>
                        <TableCell>
