    ...
    if (org) {
      ...
      if (org.settings) {
        if (org.settings.regional) {
          setRegionalSettings({ ...regionalSettings, ...org.settings.regional })
        }
        if (org.settings.notifications) {
          setNotificationSettings({ ...notificationSettings, ...org.settings.notifications })
        }
        if (org.settings.security) {
          setSecuritySettings({ ...securitySettings, ...org.settings.security })
        }
        if (org.settings.modules) {
          setModuleSettings({ ...moduleSettings, ...org.settings.modules })
        }
        if (org.settings.appearance) {
          setAppearanceSettings({ ...appearanceSettings, ...org.settings.appearance })
        }
      }
    }
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <div className="flex items-center space-x-2">
                  <Link href="/admin" className="text-sm text-indigo-600 hover:text-indigo-500">Admin Dashboard</Link>
                  <span className="text-gray-400">/</span>
                  <span className="text-sm text-gray-500">System Settings</span>
                </div>
                <h1 className="text-2xl font-bold text-gray-900">System Settings</h1>
                <p className="mt-1 text-sm text-gray-500">
                  Configure system-wide settings and preferences for {organization?.name || 'your organization'}
                </p>
              </div>
            </div>
          </div>
              ...
              <Card>
                <nav className="space-y-1">
                  {tabs.map((tab) => (
                    ...
                    >
                      <tab.icon className={`mr-3 h-5 w-5 ${activeTab === tab.id ? 'text-indigo-600' : 'text-gray-400'}`} />
                      {tab.name}
                    </button>
                  ))}
                </nav>
                ...
                <Card title="Regional Settings">
                  <div className="space-y-6">
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                      <div className="flex">
                        ...
                        <p className="text-sm text-blue-800">
                          These settings affect how dates, times, and currencies are displayed throughout the application.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      >
                        <option value="YYYY-MM-DD">YYYY-MM-DD (2024-12-08)</option>
                        <option value="DD/MM/YYYY">DD/MM/YYYY (08/12/2024)</option>
                        <option value="MM/DD/YYYY">MM/DD/YYYY (12/08/2024)</option>
                        <option value="DD-MM-YYYY">DD-MM-YYYY (08-12-2024)</option>
                        <option value="MMM DD, YYYY">MMM DD, YYYY (Dec 08, 2024)</option>
                      </FormSelect>
                      <FormSelect
                        label="Time Format"
                      ...
                      <FormSelect
                        ...
                        onChange={(e) => setRegionalSettings({ ...regionalSettings, firstDayOfWeek: e.target.value })}
                      >
                  ...
                  <Card title="General Notifications">
                    <div className="divide-y">
                      ...
                      <ToggleSwitch
                        ...
                        onChange={(checked) => setNotificationSettings({ ...notificationSettings, dailyDigest: checked })}
                        label="Daily Digest"
                        description="Receive a daily summary email"
                      />
                      <ToggleSwitch
                        checked={notificationSettings.weeklyReport}
                        onChange={(checked) => setNotificationSettings({ ...notificationSettings, weeklyReport: checked })}
                        label="Weekly Report"
                  ...
                  <Card title="Alert Settings">
                    <div className="divide-y">
                      ...
                      <ToggleSwitch
                        ...
                        onChange={(checked) => setNotificationSettings({ ...notificationSettings, leaveRequestAlerts: checked })}
                      ...
                      <ToggleSwitch
                        ...
                        onChange={(checked) => setNotificationSettings({ ...notificationSettings, projectDeadlineAlerts: checked })}
                      ...
                      <ToggleSwitch
                        ...
                        onChange={(checked) => setNotificationSettings({ ...notificationSettings, invoiceOverdueAlerts: checked })}
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="divide-y">
                        <ToggleSwitch
                          ...
                          onChange={(checked) => setSecuritySettings({ ...securitySettings, passwordRequireUppercase: checked })}
                          label="Require Uppercase Letters"
                          description="Passwords must contain at least one uppercase letter"
                        />
                        <ToggleSwitch
                          checked={securitySettings.passwordRequireNumbers}
                          onChange={(checked) => setSecuritySettings({ ...securitySettings, passwordRequireNumbers: checked })}
                          label="Require Numbers"
                          description="Passwords must contain at least one number"
                        />
                        <ToggleSwitch
                          checked={securitySettings.passwordRequireSpecial}
                          onChange={(checked) => setSecuritySettings({ ...securitySettings, passwordRequireSpecial: checked })}
                  ...
                  <Card title="Module Behavior">
                    <div className="divide-y">
                      <ToggleSwitch
                        ...
                        onChange={(checked) => setModuleSettings({ ...moduleSettings, autoGenerateCodes: checked })}
                      ...
                      <ToggleSwitch
                        ...
                        onChange={(checked) => setModuleSettings({ ...moduleSettings, requireApprovals: checked })}
                      ...
                      <ToggleSwitch
                        ...
                        onChange={(checked) => setModuleSettings({ ...moduleSettings, allowNegativeStock: checked })}
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="divide-y">
                      ...
                      <ToggleSwitch
                        ...
                        onChange={(checked) => setAppearanceSettings({ ...appearanceSettings, showBreadcrumbs: checked })}
                        label="Show Breadcrumbs"
                        description="Display navigation breadcrumbs"
                      />
                      <ToggleSwitch
                        checked={appearanceSettings.animationsEnabled}
                        onChange={(checked) => setAppearanceSettings({ ...appearanceSettings, animationsEnabled: checked })}
                    ...
                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                      <div className="flex">
                        ...
                        <p className="text-sm text-yellow-800">
                          Email is configured through Supabase. Visit your Supabase dashboard to configure email templates and SMTP settings.
                        </p>
                      </div>
                    </div>
                    <FormInput
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-500">Document and image storage</p>
                          </div>
                        </div>
                        <span className="px-3 py-1 text-xs font-medium rounded-full bg-green-100 text-green-800">
                          Connected
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <p className="font-medium">Daily (Managed by Supabase)</p>
                        </div>
                        <div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between py-3">
                        <div>
                          ...
                          <p className="text-sm text-gray-500">Permanently delete all organization data</p>
                        </div>
                        <Button variant="danger" size="sm">
                          Delete Data
                        </Button>
