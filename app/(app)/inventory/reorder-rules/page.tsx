...
import { ClipboardDocumentCheckIcon, PlusIcon, PencilIcon, TrashIcon, ExclamationTriangleIcon, ArrowLeftIcon } from '@heroicons/react/24/outline'
...
export default function ReorderRulesPage() {
  ...
  const lowStockRules = rules.filter(rule => {
    ...
    return rule.current_stock !== undefined && rule.current_stock <= rule.min_quantity
  })
                  ...
                  {filteredRules.length === 0 ? (
                    <TableRow>
                      <TableCell colSpan={7} className="text-center text-gray-500 py-8">
                        No reorder rules found. Create rules to get low stock alerts.
                      </TableCell>
                    </TableRow>
                  ) : (
                      ...
                      <TableRow key={rule.id}>
                        <TableCell>
                          <div>
                            ...
                            <p className="text-sm text-gray-500">{rule.item_sku}</p>
                          </div>
                        </TableCell>
                        ...
                        <TableCell>
                          <div className="flex items-center space-x-2">
                            ...
                            <button
                              ...
                              className={rule.is_active ? 'text-yellow-600 hover:text-yellow-900' : 'text-green-600 hover:text-green-900'}
                            >
