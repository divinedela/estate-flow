...
export default function ItemsPage() {
  ...
  const fetchItems = async () => {
    ...
    const totalValue = itemsWithStock.reduce((sum, i) => sum + (i.stock_value || 0), 0)
  ...
  const handleDelete = async (id: string) => {
    if (!confirm('Are you sure you want to delete this item? This will also delete related stock levels.')) return
  ...
  const exportItems = () => {
    const csvContent = [
      ['Item Code', 'Name', 'Category', 'Unit', 'Unit Price', 'Stock', 'Stock Value', 'Min Stock', 'Status'].join(','),
    ...
    <RoleGuard allowedRoles={['super_admin', 'inventory_officer', 'project_manager']}>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-red-600">
                    {stats.lowStockItems} item(s) are below minimum stock level. Consider reordering.
                  </p>
                </div>
              </div>
            </div>
                    ...
                    {filteredItems.length === 0 ? (
                      ...
                      filteredItems.map((item) => (
                        <TableRow key={item.id} className={item.is_low_stock ? 'bg-red-50' : ''}>
                          ...
                          <TableCell>
                            <span className="capitalize text-sm">{item.category || 'N/A'}</span>
                          </TableCell>
                          <TableCell>
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Pricing */}
            <div className="border-b pb-4">
              <h4 className="text-sm font-medium text-gray-700 mb-3">Pricing & Units</h4>
