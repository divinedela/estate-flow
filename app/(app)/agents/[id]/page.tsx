      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-4">
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-lg p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold mt-2">{agent.total_sales_count || 0}</p>
              </div>
          ...
          <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl shadow-lg p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-green-100 text-sm font-medium">Sales Value</p>
                <p className="text-3xl font-bold mt-2">{formatCurrency(agent.total_sales_value || 0)}</p>
              </div>
          ...
          <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl shadow-lg p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-purple-100 text-sm font-medium">Commission Earned</p>
                <p className="text-3xl font-bold mt-2">{formatCurrency(agent.total_commission_earned || 0)}</p>
              </div>
          ...
          <div className="bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-xl shadow-lg p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold mt-2">{formatCurrency(agent.average_deal_size || 0)}</p>
              </div>
                    ...
                    <div className="mt-1 flex items-start text-sm text-gray-900">
                      ...
                      <div>
                        ...
                        {(agent.city || agent.state || agent.postal_code) && (
                          <p>{agent.city}{agent.city && agent.state && ', '}{agent.state} {agent.postal_code}</p>
                        )}
            ...
            <Card>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-900">{agent.license_number || 'N/A'}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">State</p>
                  <p className="mt-1 text-sm text-gray-900">{agent.license_state || 'N/A'}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">Expiry Date</p>
                  <p className="mt-1 text-sm text-gray-900">{formatDate(agent.license_expiry_date)}</p>
                  {agent.license_expiry_date && new Date(agent.license_expiry_date) < new Date() && (
            ...
            <Card>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <span className={`inline-flex mt-2 rounded-full px-3 py-1 text-xs font-semibold ${statusColors[agent.employment_status] || statusColors.inactive}`}>
                    {agent.employment_status?.replace('_', ' ')}
                  </span>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">Agent Level</p>
                  <span className={`inline-flex mt-2 rounded-full px-3 py-1 text-xs font-semibold ${levelColors[agent.agent_level] || levelColors.junior}`}>
                    {agent.agent_level?.replace('_', ' ')}
                  </span>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">Employment Type</p>
                  <p className="mt-1 text-sm text-gray-900 capitalize">{agent.employment_type?.replace('_', ' ')}</p>
                </div>
                <div>
            ...
            <Card>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-900 capitalize">{agent.commission_type?.replace('_', ' ')}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">Rate</p>
                  <p className="mt-1 text-2xl font-bold text-indigo-600">{agent.commission_rate}%</p>
                </div>
            ...
            <Card>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="mt-1 text-2xl font-bold text-green-600">{agent.conversion_rate || 0}%</p>
                </div>
                <div className="pt-3 border-t border-gray-200">
                  <div className="flex justify-between items-center mb-2">
                    <p className="text-xs font-medium text-gray-500">TOTAL SALES</p>
                    <p className="text-sm font-semibold text-gray-900">{agent.total_sales_count || 0}</p>
                  </div>
                  <div className="flex justify-between items-center">
                    <p className="text-xs font-medium text-gray-500">COMMISSION EARNED</p>
                    <p className="text-sm font-semibold text-gray-900">{formatCurrency(agent.total_commission_earned || 0)}</p>
                  </div>
                </div>
              </div>
            </Card>
