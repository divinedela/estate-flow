                    ...
                    <TableRow key={po.id}>
                      ...
                      <TableCell>
                        <div className="flex items-center space-x-2">
                          ...
                          {["sent", "confirmed", "partial"].includes(
                            po.status
                          ) && (
                            <select
                              value={po.status}
                              onChange={(e) =>
                                updateStatus(po.id, e.target.value)
                              }
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-sm text-blue-800">
              After creating the PO, you can add line items, send it to the
              supplier, and track delivery status.
            </p>
          </div>
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Created on{" "}
                  {new Date(viewingPO.created_at).toLocaleDateString()}
                </p>
              </div>
              <span
                className={`px-3 py-1 text-sm font-medium rounded-full ${
                  statusColors[viewingPO.status]
                }`}
              >
                {viewingPO.status}
              </span>
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span>
                      {viewingPO.issued_date
                        ? new Date(viewingPO.issued_date).toLocaleDateString()
                        : "N/A"}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    ...
                    <span>
                      {viewingPO.expected_delivery_date
                        ? new Date(
                            viewingPO.expected_delivery_date
                          ).toLocaleDateString()
                        : "N/A"}
