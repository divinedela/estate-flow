...
export default function SuppliersPage() {
  ...
  const stats = {
    ...
    avgRating: suppliers.filter(s => s.rating).length > 0
                  ...
                  {filteredSuppliers.length === 0 ? (
                    <TableRow>
                      <TableCell colSpan={8} className="text-center text-gray-500 py-8">
                        No suppliers found. <button onClick={openCreateModal} className="text-emerald-600 hover:text-emerald-500">Add your first supplier</button>
                      </TableCell>
                    </TableRow>
                  ) : (
                      ...
                      <TableRow key={supplier.id}>
                        ...
                        <TableCell>
                          <button
                            ...
                            className={`px-2 py-1 text-xs font-medium rounded-full ${statusColors[supplier.status]} cursor-pointer hover:opacity-80`}
                          >
                            {supplier.status}
                          </button>
                        </TableCell>
            ...
            <div className="space-y-6">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-lg font-semibold">{viewingSupplier.supplier_code}</p>
                </div>
                <span className={`px-3 py-1 text-sm font-medium rounded-full ${statusColors[viewingSupplier.status]}`}>
                  ...
                  <div className="space-y-2">
                    ...
                    {viewingSupplier.email && (
                      <div className="flex items-center text-sm">
                        ...
                        <a href={`mailto:${viewingSupplier.email}`} className="text-emerald-600 hover:underline">
                          {viewingSupplier.email}
                        </a>
                      </div>
                    )}
                  ...
                  <div className="flex items-start text-sm">
                    ...
                    <div>
                      ...
                      {(viewingSupplier.city || viewingSupplier.state) && (
                        <p>{[viewingSupplier.city, viewingSupplier.state].filter(Boolean).join(', ')}</p>
                      )}
                      {(viewingSupplier.country || viewingSupplier.postal_code) && (
                        <p>{[viewingSupplier.country, viewingSupplier.postal_code].filter(Boolean).join(' ')}</p>
                      )}
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <h4 className="text-sm font-medium text-gray-500 mb-3">Business Details</h4>
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    {viewingSupplier.rating && (
                      <span className="text-sm text-gray-500">({viewingSupplier.rating}/5)</span>
                    )}
                  </div>
                </div>
              </div>
              ...
              {viewingSupplier.notes && (
                <div>
                  ...
                  <p className="text-sm text-gray-700 bg-gray-50 rounded-lg p-3">{viewingSupplier.notes}</p>
                </div>
              )}

              <div className="text-sm text-gray-500">
                Added on {new Date(viewingSupplier.created_at).toLocaleDateString()}
              </div>
