    ...
    <RoleGuard allowedRoles={['super_admin', 'project_manager', 'site_engineer', 'executive']}>
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Issues Tracking</h1>
          ...
          <Card>
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold text-gray-900">{stats.openIssues}</p>
              </div>
            </div>
          </Card>
          ...
          <Card>
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold text-gray-900">{stats.inProgressIssues}</p>
              </div>
            </div>
          </Card>
                    ...
                    <TableRow key={issue.id} className="hover:bg-gray-50">
                      ...
                      <TableCell>
                        <div className="flex items-center">
                          ...
                          <span className="text-sm text-gray-900">{issue.project_name}</span>
                        </div>
                      </TableCell>
                      <TableCell>
                        <span className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium ${typeColors[issue.issue_type] || typeColors.issue}`}>
                          {issue.issue_type}
                        </span>
                      </TableCell>
                      <TableCell>
                        <span className={`inline-flex rounded-full px-2 text-xs font-semibold leading-5 ${severityColors[issue.severity] || severityColors.medium}`}>
                          {issue.severity}
                        </span>
                      </TableCell>
                      <TableCell>
                        <span className={`inline-flex rounded-full px-2 text-xs font-semibold leading-5 ${statusColors[issue.status] || statusColors.open}`}>
                      ...
                      <TableCell className="text-sm font-medium">
                        <Link href={`/projects/issues/${issue.id}`} className="text-indigo-600 hover:text-indigo-900">
                          View Details
                        </Link>
                      </TableCell>
                    </TableRow>
